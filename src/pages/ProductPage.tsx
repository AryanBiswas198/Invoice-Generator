...
//     }));
//     const response = dispatch(addProductAPI(product, token));
//     const productId = response?.data?._id;
//     if(productId){
//         productIdMap[product.name] = productId;
//     }
//   };
...
//     }));
//     dispatch(updateProductQuantityAPI( productId.toString(), newQuantity, token ));
//   };
...
//     dispatch(removeProductAPI( productId.toString(), token ));
//   };
...
//                 <button onClick={() => handleUpdateQuantity(product.id, selectedProducts[product.id] + 1)} className="px-3 py-1 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md">+</button>
//                 <button onClick={() => handleRemoveProduct(product.id)} className="px-3 py-1 bg-red-500 hover:bg-red-600 text-white rounded-md">Remove</button>
//               </div>
//             ) : (
